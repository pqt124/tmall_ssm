...
<div class="imgAndInfo">
    ...
    <div class="imgInimgAndInfo">
        <img src="img/productSingle/${p.getFirstImage()}.jpg" class="bigImg">
            ...
            <div class="productPriceDiv">
                ...
                <div class="originalDiv">
                    ...
                    <span class="originalPrice">
                        ...
                        <fmt:formatNumber type="number" value="${p.getOriginalPrice()}" minFractionDigits="2"/>
                    </span>
                </div>
                <div class="promotionDiv">
                    ...
                    <span class="promotionPrice">
                        <fmt:formatNumber type="number" value="${p.getPromotePrice()}" minFractionDigits="2"/>
                    </span>
                </div>
            </div>
        </div>
