...
<div class="buyPageDiv">
    <form action="forecreateOrderByCart" method="post">
        <div class="buyFlow">
            ...
            <table class="productListTable">
                ...
                <c:forEach items="${ois}" var="oi" varStatus="st" >
                    <tr class="orderItemTR">
                        <td class="orderItemFirstTD"><img class="orderItemImg" src="img/productSingle_middle/${oi.product.firstImage}.jpg"></td>
